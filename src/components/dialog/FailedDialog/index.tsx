...
const FailedDialog = ({ title, description }: DialogProps) => {
  return (
    <DialogLayout>
      ...
      <button className="rounded flex items-center justify-center p-2 px-4 bg-green-500 text-white shadow-lg shadowg-red-500/50 transition-transform hover:scale-[1.03]">
